      ...
      <div className="min-h-screen bg-[#1a1a1a] text-white font-[family-name:var(--font-jakarta)]">
        ...
        <main className="pt-10 pb-0">
          ...
          <div className="flex flex-col sm:flex-row sm:flex-wrap sm:items-center gap-5">
            <a
              href="https://github.com/Abjcodes/Muffle-releases/releases/download/prod/Muffle1.2.dmg"
              download
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center w-full sm:w-auto px-7 py-4 rounded-full bg-white/10 border border-white/20 text-white font-semibold text-base hover:bg-white/15 transition-all duration-200 backdrop-blur-md shadow-[inset_0_1px_0_rgba(255,255,255,0.15),0_4px_24px_rgba(0,0,0,0.3)]"
            >
            ...
            <a
              href="https://apps.microsoft.com/store/detail/9NG65VGT41PP"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center w-full sm:w-auto px-7 py-4 rounded-full bg-white/10 border border-white/20 text-white font-semibold text-base hover:bg-white/15 transition-all duration-200 backdrop-blur-md shadow-[inset_0_1px_0_rgba(255,255,255,0.15),0_4px_24px_rgba(0,0,0,0.3)]"
            >
              <svg className="w-4 h-4 mr-2 flex-shrink-0" viewBox="0 0 88 88" fill="currentColor" aria-hidden="true">
                <path d="M0 12.402l35.687-4.86.016 34.423-35.67.203zm35.67 33.529l.028 34.453L.028 75.48.026 45.7zm4.326-39.025L87.314 0v41.527l-47.318.376zm47.329 39.349l-.015 41.34-47.318-6.678-.066-34.739z"/>
              </svg>
              Download for Windows
            </a>
            <span className="text-sm text-white/40">
              7 day free trial&nbsp;·&nbsp;Supported from MacOS 14.0 & Windows 10
            </span>
          </div>
        </main>
        ...
        <footer className="relative overflow-hidden">
          {/* Download button */}
          <div className="flex flex-col sm:flex-row gap-4 items-center justify-center pt-16 pb-10 relative z-10 px-10 md:px-20">
            <a
              href="https://github.com/Abjcodes/Muffle-releases/releases/download/prod/Muffle1.2.dmg"
              download
              rel="noopener noreferrer"
          ...
          <div className="flex justify-center gap-4 pb-6">
            <a href="https://discord.gg/Y79KZwAz" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-xl bg-white/[0.06] border border-white/[0.08] flex items-center justify-center text-white/30 hover:text-white/60 hover:bg-white/[0.1] transition-all duration-200">
            ...
            <a href="mailto:muffleapp@gmail.com" className="w-9 h-9 rounded-xl bg-white/[0.06] border border-white/[0.08] flex items-center justify-center text-white/30 hover:text-white/60 hover:bg-white/[0.1] transition-all duration-200">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" aria-label="Email">
